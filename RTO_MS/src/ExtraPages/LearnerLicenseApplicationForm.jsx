...
import '../MajorComponents/HomePage/LoginFunctionality/SignIn.css';
...
const LearnerLicenseApplicationForm = () => {
    ...
    // const url = "http://192.168.0.144:8080/lernerLicense/application"
    const [formData, setFormData] = useState({
        firstName: '',
        middleName: '',
        lastName: '',
        mobileNumber: '',
        userId: 3, // Assuming you have the user ID
        postalAddressDTO: {
            house: '',
            street: '',
            city: '',
...
// //         // if (age < 18) {
// //         //   console.error('User must be 18 or older to apply.');
...
//                         required
//                     >
//                         <option value="" disabled>Select RTO Office</option>
//                         <option value="KOLHAPUR">Kolhapur</option>
//                         <option value="SANGLI">Sangli</option>
//                         <option value="SATARA">Satara</option>
//                         <option value="PUNE">Pune</option>
